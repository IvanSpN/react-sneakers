    ...
    <div className="wrapper">
      <header className="header">
        <div className="header-left">
          <img src="/img/header_logo.png" alt="logo" width={40} height={40} />
          <div className="header-left-text">
            <h3 className="header-left-title">REACT SNEAKERS</h3>
            <p className="header-left-subtitle">Магазин лучших кроссовок</p>
          </div>
        </div>
